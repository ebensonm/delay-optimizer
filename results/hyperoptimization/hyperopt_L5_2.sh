...
RAY_ADDRESS=auto python -u HypOpConstantLR.py --dim 1000 --max_delay 5 --num_delays 10000 --use_delays True --maxiter 5000 \
--cost_function "ackley" --tol 1e-5 --num_runs 20 \
--filename "Ackley_Delayed_1000_5" --num_initials 20 \
--num_processes 49 --bayesian_samples 5 --grid_samples 15 \
--ranges_0 0.0 --ranges_1 2.0

RAY_ADDRESS=auto python -u HypOpConstantLR.py --dim 1000 --max_delay 5 --num_delays 10000 --use_delays True --maxiter 5000 \
--cost_function "rastrigin" --tol 1e-5 --num_runs 20 \
--filename "Rastrigin_Delayed_1000_5" --num_initials 20 \
--num_processes 49 --bayesian_samples 5 --grid_samples 15 \
--ranges_0 0.0 --ranges_1 2.0

RAY_ADDRESS=auto python -u HypOpConstantLR.py --dim 1000 --max_delay 5 --num_delays 10000 --use_delays True --maxiter 5000 \
--cost_function "zakharov" --tol 1e-5 --num_runs 20 \
--filename "Zakharov_Delayed_1000_5" --num_initials 20 \
...
--filename "Rosenbrock_Delayed_1000_5" --num_initials 20 \
