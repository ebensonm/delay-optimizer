...
--num_tests 1 --filename "Zak_2d" --num_test_initials 5
...
--optimizer_name "Adam" --loss_name "Zakharov" --tol 1e-5 \
--max_evals 200 --symmetric_delays True --constant_learning_rate False \
--num_tests 1 --filename "Zak_10d" --num_test_initials 5
...
--optimizer_name "Adam" --loss_name "Zakharov" --tol 1e-5 \
--max_evals 200 --symmetric_delays True --constant_learning_rate False \
--num_tests 1 --filename "Zak_100d" --num_test_initials 5
...
--optimizer_name "Adam" --loss_name "Zakharov" --tol 1e-5 \
--max_evals 200 --symmetric_delays True --constant_learning_rate False \
--num_tests 1 --filename "Zak_1000d" --num_test_initials 5
...
--optimizer_name "Adam" --loss_name "Zakharov" --tol 1e-5 \
--max_evals 200 --symmetric_delays True --constant_learning_rate False \
--num_tests 1 --filename "Zak_10000d" --num_test_initials 5
