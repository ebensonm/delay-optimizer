...
--use_delays True --maxiter 10000 \
--cost_function "zakharov" --tol 1e-5 --num_runs 10 \
--filename "Zakharov_Delayed0_10" --num_initials 10 \
...
--use_delays True --maxiter 10000 \
--cost_function "zakharov" --tol 1e-5 --num_runs 10 \
--filename "Zakharov_Delayed0_100" --num_initials 10 \
--num_processes 25 --bayesian_samples 5 --grid_samples 30 \
--max_range_0 0.0 --max_range_1 10.0
...
--use_delays True --maxiter 10000 \
--cost_function "zakharov" --tol 1e-5 --num_runs 10 \
--filename "Zakharov_Delayed0_1000" --num_initials 10 \
--num_processes 25 --bayesian_samples 5 --grid_samples 30 \
--max_range_0 0.0 --max_range_1 10.0
...
--use_delays True --maxiter 10000 \
--cost_function "zakharov" --tol 1e-5 --num_runs 10 \
--filename "Zakharov_Delayed1_10" --num_initials 10 \
--num_processes 25 --bayesian_samples 5 --grid_samples 30 \
--max_range_0 0.0 --max_range_1 10.0
...
--use_delays True --maxiter 10000 \
--cost_function "zakharov" --tol 1e-5 --num_runs 10 \
--filename "Zakharov_Delayed1_100" --num_initials 10 \
--num_processes 25 --bayesian_samples 5 --grid_samples 30 \
--max_range_0 0.0 --max_range_1 10.0
...
--use_delays True --maxiter 10000 \
--cost_function "zakharov" --tol 1e-5 --num_runs 10 \
--filename "Zakharov_Delayed1_1000" --num_initials 10 \
--num_processes 25 --bayesian_samples 5 --grid_samples 30 \
--max_range_0 0.0 --max_range_1 10.0
