...
--num_tests 1 --filename "Rosen_2d" --num_test_initials 5
...
--optimizer_name "Adam" --loss_name "Rosenbrock" --tol 1e-5 \
--max_evals 200 --symmetric_delays True --constant_learning_rate False \
--num_tests 1 --filename "Rosen_10d" --num_test_initials 5
...
--optimizer_name "Adam" --loss_name "Rosenbrock" --tol 1e-5 \
--max_evals 200 --symmetric_delays True --constant_learning_rate False \
--num_tests 1 --filename "Rosen_100d" --num_test_initials 5
...
--optimizer_name "Adam" --loss_name "Rosenbrock" --tol 1e-5 \
--max_evals 200 --symmetric_delays True --constant_learning_rate False \
--num_tests 1 --filename "Rosen_1000d" --num_test_initials 5
...
--optimizer_name "Adam" --loss_name "Rosenbrock" --tol 1e-5 \
--max_evals 200 --symmetric_delays True --constant_learning_rate False \
--num_tests 1 --filename "Rosen_10000d" --num_test_initials 5
